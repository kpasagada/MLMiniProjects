...
iteration_counter = 1
total_loss = 0.0
w_vector = 0.2 * np.ones((22,), dtype=float)
b_value = 0.7
...
for i in range(len(test_data)):
    ...
    pred_array.append(predict(w_vector, b_value, slice_data))

print("W vector:", w_vector)
print("B value:", b_value)
print("Accuracy on test data:", accuracy(pred_array, actual_data))